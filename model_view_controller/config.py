...
def generate_workspace_state_file(workspace_path: str) -> str:
    ...
    info_message = ("# This is a generated workspace state file. MVC makes use of this to track changes in your workspace.\n"
                    "# Do not edit this file manually, and do not commit it to version control. ")
    # Add info message as comment on top of the file
    return write_file(
        new_file_path, f"{info_message}\n{yaml.dump(workspace_files_data)}"
    )
